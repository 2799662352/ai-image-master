...
分镜技法库:**29 个 `storyboard-*` craft skill**,负责单镜画面级的打磨与参考图/视频反推。与 `catimation-director` 配合——成套写镜头先过导演总调度,本库提供逐镜的具体技法。
...
- **网格/序列**:storyboard-grid-to-seedance(一张多格故事板锁镜头顺序与构图,再让图生视频按格子顺序补运动;附 9 维分镜表/LUT/Seedance 6 铁律/情绪生理 references)
