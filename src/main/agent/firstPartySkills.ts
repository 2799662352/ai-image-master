...
> 进阶 — 成片要**发布/交付**时,用 \`ffmpeg-win\` 技能的 **Review / 审片** 段做更全的
> 质检:\`ffprobe\` 流/时长/比例检查、响度 EBU R128(≈ -14 LUFS)、release
> checkpoint 海报帧 + 人工签收、以及编码前的 preflight guardrails。上面的九宫格是
> 快检,审片段是发布前的完整把关。
