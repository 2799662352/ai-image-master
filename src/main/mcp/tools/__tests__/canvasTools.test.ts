...
describe('registerCanvasTools', () => {
  it('registers renderer + queue tools', () => {
    ...
    for (const name of ['canvas_open', 'canvas_snapshot', 'canvas_focus_region', 'canvas_arrange', 'canvas_create_shape', 'canvas_update_shape', 'canvas_delete_shapes', 'list_canvas_images', 'get_canvas_image', 'get_canvas_video', 'create_image_holder', 'insert_image_into_holder', 'insert_video', 'collect_annotations', 'create_image_version', 'save_snapshot', 'save_checkpoint', 'load_checkpoint', 'list_checkpoints', 'canvas_exec', 'canvas_search', 'watch_edit_requests', 'get_edit_request', 'update_edit_request']) {
